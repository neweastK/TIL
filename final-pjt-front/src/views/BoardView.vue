  ...
  <div class="container">
    <ul class="nav nav-tabs">
      ...
      <table class="table table-hover">
        ...
        <tbody>
          <tr v-for="article in board_article" :key="article.pk">
            <td>
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
        <button class="btn" style="background-color: MidnightBlue;" type="button"><router-link :to="{ name: 'boardnew' }" class="text-decoration-none" style="color:white;">글쓰기</router-link></button>
      </div>
